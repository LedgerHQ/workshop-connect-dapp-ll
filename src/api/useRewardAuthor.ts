...
/* STEP #6
    ...
    TIPS: There is one hook from the wagmi documentation that allow you to send a transaction
...
const useRewardAuthor = () => {
    ...
    return { data: null, isError: false, isLoading: false, isSuccess: false, isIdle: false, rewardAuthor };
};
